# Generated by Django 2.0.9 on 2019-04-13 20:03
...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.CreateModel(
            name='Comment',
            fields=[
                ('commentid', models.CharField(max_length=150, primary_key=True, serialize=False, verbose_name='评论id')),
        ...
        migrations.CreateModel(
            name='Cutting',
            fields=[
                ('cutid', models.CharField(max_length=150, primary_key=True, serialize=False, verbose_name='砍价编号')),
        ...
        migrations.CreateModel(
            name='Need',
            fields=[
                ('needid', models.BigAutoField(primary_key=True, serialize=False)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('gender', models.IntegerField(choices=[(0, '未知'), (1, '男'), (2, '女')], verbose_name='性别')),
