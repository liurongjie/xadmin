# Generated by Django 2.0.9 on 2019-05-03 17:29
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.IntegerField(choices=[(0, '订单取消'), (1, '预付完成'), (2, '拼团完成'), (3, '支付完成'), (4, '订单完成')], default=1, verbose_name='状态')),
                ('state', models.SmallIntegerField(choices=[(0, '大船'), (1, '小船')], verbose_name='发船类型')),
                ('cutprice', models.FloatField(verbose_name='参团成员砍价')),
                ...
                ('time5', models.DateTimeField(blank=True, null=True, verbose_name='订单取消时间')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.SmallIntegerField(choices=[(0, '仅仅获取昵称'), (1, '获取手机号'), (2, '院系信息')], verbose_name='当前状态')),
                ...
                ('time', models.DateTimeField(blank=True, null=True, verbose_name='实名认证时间')),
